  ...
  <main>
        ...
        <div id="projects-container">
         ...
         <aside class="project-box" id="cardoozy">
          ...
          <aside class="project-box" id="codetri">
            ...
            <div class="desc">
              <p>My personal site, which you are currently browsing. Registered in July 2015, the current design iteration (and yes, it is <a target="_blank" rel="noopener noreferrer" href="https://github.com/le717/CodeTriangle">open-source</a>) was published on February 29, 2016.</p>
            </div>
          </aside>
          ...
          <aside class="project-box" id="htmlskel">
            ...
            <div class="desc">
              <p>Initially developed to eliminate redundant HTML typing in class, it was later expanded to insert commonly used HTML snippets. Since <a target="_blank" rel="noopener noreferrer" href="https://github.com/le717/brackets-html-skeleton">open-sourcing</a> and uploading to the extension registry, this small, occasionally updated <a target="_blank" rel="noopener noreferrer" href="http://brackets.io">Brackets</a> extension has been downloaded over 85,000 times with 9,600 active installations.</p>
            </div>
          </aside>
        </div>
      </div>
    ...
    <section class="page-section alt" id="about">
      <div class="text-content">
        ...
        <p>I began programming in January 2013 by teaching myself Python, and in September I enrolled at <a target="_blank" rel="noopener noreferrer" href="http://southeasterntech.edu/">Southeastern Technical College</a>, obtaining my Associates of Applied Science in Website Development and graduating with honors in December 2015. I am currently enrolled at <a target="_blank" rel="noopener noreferrer" href="http://ega.edu">East Georgia State College</a> working on my Bachelor's degree.</p>
    ...
    <section class="page-section social" id="contact">
      <div class="text-content">
        ...
        <div class="social-icons">
          <a target="_blank" rel="noopener noreferrer" href="https://twitter.com/cely717">
            <div class="icon fi-social-twitter"></div>
            <span class="text">Twitter</span>
          </a>

          <a target="_blank" rel="noopener noreferrer" href="https://github.com/le717">
            <div class="icon fi-social-github"></div>
            <span class="text">GitHub</span>
          </a>

          <a target="_blank" rel="noopener noreferrer" href="https://medium.com/@cely717">
